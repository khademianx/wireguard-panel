...
mkdir /opt/wireguard && \
    cd /opt/wireguard && \
    curl -o ./docker-compose.yml https://raw.githubusercontent.com/khademianx/wireguard-panel/refs/heads/main/docker-compose.yml && \
    curl -o ./.env https://raw.githubusercontent.com/khademianx/wireguard-panel/refs/heads/main/.env.example
